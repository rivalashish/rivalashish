...
try:
    ...
    print("Something went wrong --->> Check First try Block")

try:
    # Graph using adjacency matrix
    class GraphAM:
        # adjacency matrix of size n*n initialize with 0
    ...
    print("Something went wrong --->>> Check Class Definition -->> if 1st try block is Working")
